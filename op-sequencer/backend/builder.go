...
func (b *Worker) prepareEnv() {
	...
	b.env = vm.NewEVM(blockCtx, vm.TxContext{}, b.state, b.chainCfg, vmCfg)
}
...
func (b *Worker) blockPrefix() {
	...
	if b.attrs.ParentBeaconBlockRoot != nil {
		core.ProcessBeaconBlockRoot(*b.attrs.ParentBeaconBlockRoot, b.env, b.baseState)
	}
	if b.chainCfg.IsPrague(b.env.Context.BlockNumber, b.env.Context.Time) {
		core.ProcessParentBlockHash(b.parentHash, b.env, b.baseState)
	}
