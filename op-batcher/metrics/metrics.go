...
func NewMetrics(procName string) *Metrics {
	...
	m := &Metrics{
		...
		pendingBlocksBytesTotal: factory.NewCounter(prometheus.CounterOpts{
			...
			Help:      "Total estimated L1 batch size of transactions in pending blocks as they are fetched from L2",
		}),
	...
	m.pendingBlocksBytesCurrent = factory.NewGaugeFunc(prometheus.GaugeOpts{
		...
		Help:      "Current estimated L1 batch size of transactions in the pending (fetched from L2 but not in a channel) stage.",
	}, m.PendingBytes)
