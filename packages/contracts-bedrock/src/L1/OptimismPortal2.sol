...
contract OptimismPortal2 is Initializable, ResourceMetering, ISemver {
    ...
    function gasPayingToken() private view returns (address addr_, uint8 decimals_) {
    ...
    ///        _mint       Units of ERC20 token to deposit into L2.
    ///        _value      Units of ERC20 token to send on L2 to the recipient.
    ...
    function depositERC20Transaction(address, uint256, uint256, uint64, bool, bytes memory) public pure {
        revert CustomGasTokenNotSupported();
    }
