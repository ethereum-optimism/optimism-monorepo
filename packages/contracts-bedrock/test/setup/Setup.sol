...
contract Setup {
    ...
    function L1() public {
        ...
        vm.label(address(disputeGameFactory), "DisputeGameFactoryProxy");
        vm.label(EIP1967Helper.getImplementation(address(disputeGameFactory)), "DisputeGameFactoryImpl");
        vm.label(address(delayedWeth), "DelayedWETHProxy");
        vm.label(EIP1967Helper.getImplementation(address(delayedWeth)), "DelayedWETHImpl");
        vm.label(address(systemConfig), "SystemConfigProxy");
        vm.label(EIP1967Helper.getImplementation(address(systemConfig)), "SystemConfigImpl");
        vm.label(address(l1StandardBridge), "L1StandardBridgeProxy");
        vm.label(EIP1967Helper.getImplementation(address(l1StandardBridge)), "L1StandardBridgeImpl");
        vm.label(address(l1CrossDomainMessenger), "L1CrossDomainMessengerProxy");
        vm.label(EIP1967Helper.getImplementation(address(l1CrossDomainMessenger)), "L1CrossDomainMessengerImpl");
        vm.label(address(addressManager), "AddressManager");
        vm.label(address(l1ERC721Bridge), "L1ERC721BridgeProxy");
        vm.label(EIP1967Helper.getImplementation(address(l1ERC721Bridge)), "L1ERC721BridgeImpl");
        vm.label(address(l1OptimismMintableERC20Factory), "OptimismMintableERC20FactoryProxy");
        vm.label(EIP1967Helper.getImplementation(address(l1OptimismMintableERC20Factory)), "OptimismMintableERC20FactoryImpl");
        vm.label(address(protocolVersions), "ProtocolVersionsProxy");
        vm.label(EIP1967Helper.getImplementation(address(protocolVersions)), "ProtocolVersionsImpl");
        vm.label(address(superchainConfig), "SuperchainConfigProxy");
        vm.label(EIP1967Helper.getImplementation(address(superchainConfig)), "SuperchainConfigImpl");
        vm.label(address(anchorStateRegistry), "AnchorStateRegistryProxy");
        vm.label(EIP1967Helper.getImplementation(address(anchorStateRegistry)), "AnchorStateRegistryImpl");
