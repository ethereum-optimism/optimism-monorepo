...
contract Specification_Test is CommonTest {
    ...
    function setUp() public override {
        ...
        _addSpec({
            _name: "OptimismPortalInterop",
            _sel: _getSel(
                "proveWithdrawalTransaction((uint256,address,address,uint256,uint256,bytes),uint256,uint256,(bytes1,uint64,(uint256,bytes32)[]),(bytes32,bytes32,bytes32,bytes32),bytes[])"
            ),
            _pausable: true
        });
