...
contract AnchorStateRegistry_GetAnchorRoot_Test is AnchorStateRegistry_Init {
    ...
    function test_getAnchorRoot_noAnchorGame_succeeds() public view {
        // Note: Even on a fork test, this test passes the zero address check, which seems weird to me.
        //   Does the upgrade path need to call `setAnchorRoot(respectedGame)`?
